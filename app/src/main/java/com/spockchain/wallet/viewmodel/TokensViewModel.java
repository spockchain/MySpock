...
import com.spockchain.wallet.service.TickerService;
import com.spockchain.wallet.service.UpWalletTickerService;
...
public class TokensViewModel extends BaseViewModel {
    ...
    TokensViewModel(
        ...
        tickerService = new UpWalletTickerService(MySpockApp.okHttpClient(), new Gson());
    }
