...
//    }
    ...
    public static int dip2px(float dipValue) {
        float scale = MySpockApp.getsInstance().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        float fontScale = MySpockApp.getsInstance().getResources().getDisplayMetrics().scaledDensity;
